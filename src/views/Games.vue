  ...
  <div>
    ...
    <div class="games">
      ...
      <v-layout id="all_games" v-else class="mb-5">
        <v-card max-width="288" v-for="game in filteredGames" :key="game.id">
          <v-img
          ...
          <div class="wrap">
            ...
            <div class="wrap-actions">
              <v-card-actions class="actions">
                <v-btn id="btnColor" text @click="addToBasket(game)">
                  Add
                  <v-icon id="iColor" class="icon">shopping_basket</v-icon>
                </v-btn>

                <v-btn id="btnColor" text :to="'/games/' + game.id">
                  See More
                  <v-icon id="iColor" class="icon">search</v-icon>
                </v-btn>
              </v-card-actions>
            </div>
          </div>
...
#btnColor,
#iColor {
  color: map-get($Colorscheme, cardBtn);
}
