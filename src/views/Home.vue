  ...
  <v-layout row wrap class="mt-2" v-if="!loading">
    <v-flex xs12>
        ...
        >
          ...
          >
            <v-img class="align-end" height="100%" :aspect-ratio="16/9"  :src="slide.imageUrl">
              <v-card-title style="background-color: #00000099;">{{slide.title}}</v-card-title>
            </v-img>
    ...
    <div class="cards">
      ...
      >
        <v-img
          ...
          :src="slide.imageUrl"
        >
          <v-card-title class="text-caption font-weight-bold">{{slide.title}}</v-card-title>
        </v-img>
      </v-card>
    </div>
  </div>
